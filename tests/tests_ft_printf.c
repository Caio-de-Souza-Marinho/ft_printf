...
MU_TEST(test_ft_printf_print_one_char_one_string)
{
	// ARRANGE
	char	*s = "caio";
	char	c = 'a';
	char	expected_output[] = "caioa";
	...
	// ACT
	int	actual_return_value = ft_printf("%s%c", s, c);
...
MU_TEST_SUITE(ft_printf_test_suite)
{
	...
	MU_RUN_TEST(test_ft_printf_print_one_char_one_string);
}
